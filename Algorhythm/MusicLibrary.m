...
//        NSDictionary *riseAndShine = @{kTitle : @"Rise and Shine",
...
//                                       kArtists : @[@"American authors", @"Vacationer", @"Matt and Kim", @"MGMT", @"Echosmith", @"Tokyo Police Club",
//                                                      @"La Femme"]};
        ...
        _library = @[@{kTitle : @"Rise and Shine",
                     ...
                     @{kTitle : @"Runner's Rampage",
                       ...
                       kArtists : @[@"Avicii", @"Calvin Harris", @"Pitbull", @"Iggy Azalea", @"Rita Ora", @"Drake",
                                    @"Lil Wayne"]
                       },
                     @{kTitle : @"Joy Ride",
                       ...
                       kArtists : @[@"Afrojack", @"Kid Cudi", @"Daft Punk", @"kIcona Pop", @"Gesaffelstien", @"Roksnoix",
                                    @"deadmau5"]
                       },
                     @{kTitle : @"In The Zone",
                       ...
                       kArtists : @[@"Dr. Dre", @"Snoop Dogg", @"Com Truise", @"D12", @"Flying Lotus", @"Kanye West",
                                    @"Rundfunk"]
                       },
                     ...
                     @{kTitle : @"Futbal Remix",
                       ...
                       kArtists : @[@"Shakira", @"Santana", @"Wyclef Jean", @"Aloe Blacc", @"Pitbull", @"Enrique Eglesias",
                                    @"Ricky Martin"]
                       }];
    }
